...
public:
    ...
    virtual void copy_message_to_q(void *msg, int len) = 0;
    //helpers to minimise copying
    virtual void copy_2message_parts_to_q(void *msg1, int len1, void *msg2, int len2) = 0;
    virtual void copy_3message_parts_to_q(void *msg1, int len1, void *msg2, int len2, void *msg3, int len3) = 0;
